<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:8181/admin/');
define('HTTP_CATALOG', 'http://localhost:8181/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:8181/admin/');
define('HTTPS_CATALOG', 'http://localhost:8181/');
